# rezops — AI Engineering Workflow

rezops is a collection of SKILL.md files that give AI agents structured roles for
...
| `/rezops-upgrade` | Update rezops to the latest version. |
