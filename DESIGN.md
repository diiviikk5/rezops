# Design System — rezops

## Product Context
- **What this is:** Community website for rezops — a CLI tool that turns Claude Code into a virtual engineering team
- **Who it's for:** Developers discovering rezops, existing community members
