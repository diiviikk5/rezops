#!/usr/bin/env bun
/**
 * rezops-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   rezops-global-discover --since 7d [--format json|summary]
 *   rezops-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: rezops-global-discover --since <window> [--format json|summary]
...
Examples:
  rezops-global-discover --since 7d
  rezops-global-discover --since 14d --format summary`);
}
