# Adding a New Host to rezops

rezops uses a declarative host config system. Each supported AI coding agent
...
const myhost: HostConfig = {
  ...
  globalRoot: '.myhost/skills/rezops',
  localSkillRoot: '.myhost/skills/rezops',
  hostSubdir: '.myhost',
  ...
  pathRewrites: [
    { from: '~/.claude/skills/rezops', to: '~/.myhost/skills/rezops' },
    { from: '.claude/skills/rezops', to: '.myhost/skills/rezops' },
...
ls .myhost/skills/rezops-*/SKILL.md
