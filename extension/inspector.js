/**
 * rezops browse — CSS Inspector content script
 *
...
(() => {
  ...
  if (window.__rezopsInspectorActive) return;
  window.__rezopsInspectorActive = true;
  ...
  function createHighlight() {
    ...
    highlightEl.id = 'rezops-inspector-highlight';
    ...
    tooltipEl.id = 'rezops-inspector-tooltip';
  ...
  function onMouseMove(e) {
    ...
    if (target.id === 'rezops-inspector-highlight' || target.id === 'rezops-inspector-tooltip') return;
  ...
  function injectCSS(id, css) {
    ...
    const styleId = `rezops-inject-${id}`;
