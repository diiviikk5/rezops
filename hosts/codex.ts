...
const codex: HostConfig = {
  ...
  globalRoot: '.codex/skills/rezops',
  ...
  pathRewrites: [
    { from: '~/.claude/skills/rezops', to: '$REZOPS_ROOT' },
    { from: '.claude/skills/rezops', to: '.agents/skills/rezops' },
    { from: '.claude/skills/review', to: '.agents/skills/rezops/review' },
