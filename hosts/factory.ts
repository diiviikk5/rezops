...
const factory: HostConfig = {
  ...
  globalRoot: '.factory/skills/rezops',
  localSkillRoot: '.factory/skills/rezops',
  hostSubdir: '.factory',
  usesEnvVars: true,
  ...
  pathRewrites: [
    ...
    { from: '.claude/skills/rezops', to: '.factory/skills/rezops' },
    { from: '.claude/skills/review', to: '.factory/skills/rezops/review' },
