...
# the older V0 prose can set `rezops-config set explain_level terse`.
#
...
PROMPTED_FLAG="$REZOPS_HOME/.writing-style-prompted"
PENDING_FLAG="$REZOPS_HOME/.writing-style-prompt-pending"
...
EXPLAIN_LEVEL_SET="$("${HOME}/.claude/skills/rezops/bin/rezops-config" get explain_level 2>/dev/null || true)"
