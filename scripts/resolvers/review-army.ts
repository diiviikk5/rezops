 ...
 * 1. Detect stack and scope (via rezops-diff-scope)
...
\`\`\`bash
source <(${ctx.paths.binDir}/rezops-diff-scope <base> 2>/dev/null) || true
...
\`\`\`bash
${ctx.paths.binDir}/rezops-specialist-stats 2>/dev/null || true
\`\`\`
...
\`\`\`bash
${ctx.paths.binDir}/rezops-learnings-search --type pitfall --query "{specialist domain}" --limit 5 2>/dev/null || true
\`\`\`
