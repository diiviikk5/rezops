/**
 * rezops-model-benchmark CLI tests (offline).
 *
...
const BIN = path.join(ROOT, 'bin', 'rezops-model-benchmark');
...
describe('rezops-model-benchmark prompt resolution', () => {
