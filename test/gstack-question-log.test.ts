/**
 * bin/rezops-question-log — schema validation + injection defense tests.
 */
...
const BIN = path.join(ROOT, 'bin', 'rezops-question-log');
...
describe('rezops-question-log — valid payloads', () => {
...
describe('rezops-question-log — rejected payloads', () => {
...
describe('rezops-question-log — injection defense', () => {
  const attacks = [
