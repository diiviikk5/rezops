...
const OPENCLAW_NATIVE_SKILLS = [
  'openclaw/skills/rezops-openclaw-investigate/SKILL.md',
  'openclaw/skills/rezops-openclaw-office-hours/SKILL.md',
  'openclaw/skills/rezops-openclaw-ceo-review/SKILL.md',
  'openclaw/skills/rezops-openclaw-retro/SKILL.md',
];
