...
- Save the report to .rezops/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.rezops', 'security-reports');
...
- Skip the preamble (rezops-update-check, telemetry, etc.) — go straight to the audit.
